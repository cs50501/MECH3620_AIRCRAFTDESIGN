...
# ╔═╡ 8fe3b892-1842-11f1-a596-e9fef28cd465
begin
	using Plots
	using PlutoUI
end

# ╔═╡ 3aa0c283-19f3-4277-953b-ac73d214cbb8
# Parameters and Values

begin 
	W_payload = 70 * 15 # kg
	W_crew = 70 * 90 # kg
	WTO_guess = 33000.0  # Initial Guess
	SFC_Cruise = 0.5 # Source: Raymer's Textbook
	SFC_Loiter = 0.4 # Source: Raymer's Textbook
	LD_Max = 16 # ballpark value
	LD_Cruise = 0.866 * LD_Max # Source: Raymer's Textbook
	R = 1050 # m, (Range from HKG to CRK)
	speedofsound = 295.1 # m/s, (got from table)
	M = 0.78
	V_Cruise = M * speedofsound * 3.6
	E = 45 / 60 # s
	a = 1.06
	num = 20
	A = 1.02
	...
	takeoffWF = 0.97 # Source: Raymer's Textbook
	climbWF = 0.985 # Source: Raymer's Textbook
	landingWF = 0.995 # Source: Raymer's Textbook
end

# ╔═╡ 9c544cc4-1436-47f1-a1e8-fb97c1c56309
function maximum_takeoff_weight(W_payload, W_crew, Wf_WTO, We_WTO)
	WTO = (W_payload + W_crew) / (1 - Wf_WTO - We_WTO)
	return WTO
end

# ╔═╡ db78d55e-1e6d-4022-885d-9081c8638752
takeoff1WF = 0.97

# ╔═╡ 1da74d2b-4169-49f0-8ae8-c00283b68fa1
takeoff2WF = 0.97

# ╔═╡ 80ce0e09-e3db-40a6-b433-5987adc7b22a
climb1WF = 0.985

# ╔═╡ 8f53c407-611e-424a-899e-59f42ec13902
climb2WF = 0.985

# ╔═╡ 088a737e-d2fc-4f86-9856-5e64bd48bf32
# Cruise Weight Fraction Function
...
# ╔═╡ e06c3380-55d0-44d3-b3e4-3b3e624319e2
cruise1WF = cruise_weight_fraction(R, SFC_Cruise, V_Cruise, LD_Cruise)

# ╔═╡ ad4c21b8-5d2e-4d7d-ae60-db52007aea2b
cruise2WF = cruise_weight_fraction(R, SFC_Cruise, V_Cruise, LD_Cruise)

# ╔═╡ c97f3256-cd1a-42c3-a5a1-2cf69d3ab607
# Loiter Weight Fraction Function
...
# ╔═╡ cd735344-6123-47cc-9c30-1ee955889662
loiter1WF = loiter_weight_fraction(E, SFC_Loiter, LD_Max)

# ╔═╡ e10671ce-3f0b-4cfa-87a3-3952691805c1
loiter2WF = loiter_weight_fraction(E, SFC_Loiter, LD_Max)

# ╔═╡ 6866ddc4-0c0f-4a44-bbfd-78233d9b7134
landing1WF = 0.995

# ╔═╡ 724f1eee-e4be-472f-a496-209efe6f5f81
landing2WF = 0.995

# ╔═╡ 2be894b6-e926-4c5c-a4c4-550d5b9ef039
# Weight Fractions for Mission Profile

WFs = [takeoff1WF, climb1WF, cruise1WF, loiter1WF, landing1WF, takeoff2WF, climb2WF, cruise2WF, loiter2WF, landing2WF]

# ╔═╡ 32763d16-7d22-456b-8b2f-f3f2ef4452fb
# Fuel Weight Fraction Function
...
# ╔═╡ bdd0ab0d-bd11-448f-8410-4935bb2b10a4
Wf_WTO = fuel_weight_fraction(WFs, a)

# ╔═╡ 41ff77f6-4620-4087-b596-033673203198
# Empty Weight Fraction Function
...
# ╔═╡ b9e39451-ed39-41cd-9a9b-50afe151743d
We_WTO = empty_weight_raymer(WTO_guess, A, B)

# ╔═╡ 9b4fa7ce-d413-474c-a6da-76afc4c700f5
# Iteration
...
# ╔═╡ 1a5e2aee-8683-474e-a265-79b9cd63562c
...
# ╔═╡ 578bd047-2a33-43cd-8a88-a9d16b5078b5
WTO_list1

# ╔═╡ 0da9f17b-a36b-4ee1-afe9-1ae5295a8bb3
error_list
